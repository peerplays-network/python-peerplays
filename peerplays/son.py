...
#        return get_son_network
    ...
    def get_sidecahin_addresses_by_sidechain(self, sidechainName):
        addresses = self.blockchain.rpc.get_sidechain_addresses_by_sidechain(sidechainName)
        return addresses

    def create_son(self, accountName, listOflistOfChainPubKey):
    ...
    def sell(
        ...
        **Example:** in the BTC_PPY market, a price of 300 means
        a BTC is worth 300 PPY
